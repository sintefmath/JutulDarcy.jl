...
- Put sequential code in module + updates (#130)
- Type fix to BlackOil variable (#137)
- Improve gradients example, improve initial state gradients (#138)
- Multisegment well updates (#142)
- Fix face average inbounds call (#143)
- Correct phase properties and indexing in multicomponent bc (#146)
- Update differentiable geothermal example (#149)
- MSwell improvements + geothermal updates (#150)
- Fix objective format in compositional example (#151)

### Closed Issues
- Minor bug in multicomponent/bc.jl (#145)

### Contributors
[@moyner](https://github.com/moyner), [@strene](https://github.com/strene), [@saeedtelvari](https://github.com/saeedtelvari), [@andreas-brostrom](https://github.com/andreas-brostrom)

## [v0.2.45] - 2024-06-17

### Contributors
[@moyner](https://github.com/moyner), [@strene](https://github.com/strene), [@omahs](https://github.com/omahs), [@andreas-brostrom](https://github.com/andreas-brostrom)
...
### Merged Pull Requests
- Create DocPreviewCleanup.yml (#113)
- Timestepping updates (#114)
- Add example demonstrating blending to automatically discover regions (#115)
- Updates to gradients (#116)

### Closed Issues
- turn off print (#109)

### Contributors
[@moyner](https://github.com/moyner), [@strene](https://github.com/strene)
...
### Merged Pull Requests
- Add minimum timestep to simulator config (#99)
- Support for gradients of well controls/composition/temperature, boundary conditions and source terms (#105)
- Timestepping (#106)
- Make sure segment radius is set to wellbore radius multisegment wells (#107)
- Rate optimization utilities + example (#108)
...
### Merged Pull Requests
- Increase swap in CI (#98)
- Add utility and example for making hydrostatic equilibrium initialization easier in scripts (#101)
- Add salinity to brine viscosity in CO2 model, fix to irreversible rock compressibility, bugfixes to aquifer initialization, faster setup of models (#102)
- Make sure rock and component heat capacities are set to DataDomain (#103)
...
### Merged Pull Requests
- Support for different types of tracers + simple polymer model (#90)
- Reorganize the examples a bit (#91)
- Improve polymer model + tracers (#92)
- Updated docs, added support for tracers + polymer and improved equilibriation (#93)
- First steps towards geothermal module (#94)
- Geothermal improvements (#96)
- Enable BTES example (#97)
...
### Merged Pull Requests
- Update tests, robustness for init (#89)

### Contributors
[@moyner](https://github.com/moyner)
...
### Merged Pull Requests
- Update doc blocks in example (#82)
- Doc updates 3 (#83)
- Convert warnings to errors in docs, update docs and simplify compute_well_qoi, ZCRIT support (#84)
- Compositional improvements (#85)
...
### Merged Pull Requests
- Fix typos (#121)
- Make test deterministic and less flaky (#122)
- Update vitepress deploy (#123)
- Geothermal improvements (#124)
- Support for Jutul 0.4 + type fixes for generic differentiation (#125)
- Add test for state0 sensitivities (#128)
- Update adjoint for well controls to latest Jutul + fixes (#129)
- New optimization interface+ example (#136)

### Closed Issues
- Using Clapeyron.jl for properties? (#135)
...
### Merged Pull Requests
- CPRW support (#78)
- AMGX finalizer fix + update to Jutul 0.30 (#79)
...
### Contributors
[@moyner](https://github.com/moyner), [@jakobtorben](https://github.com/jakobtorben)
...
- Upscaling/coarsening of models, CGNet example, relperm example, LET functions, new GUIs, rewritten well plotter (#71)
...
### Contributors
[@moyner](https://github.com/moyner), [@turquoisedragon2926](https://github.com/turquoisedragon2926)

## [v0.2.34] - 2024-10-01

### Merged Pull Requests
- Rock hysteresis, fix scaled capillary pressure regression, bump HYPRE (#66)
...
- Support for salts in CO2 model, new property codes for CO2 and brine based on work by Lluis Salo (#62)

### Closed Issues
- Support for Julia 1.7 and 1.8 (#50)

### Contributors
[@moyner](https://github.com/moyner), [@grantbruer](https://github.com/grantbruer), [@lsalo](https://github.com/lsalo)
...
### Merged Pull Requests
- Bugfix to initialization and fault plots (#56)
...
### Merged Pull Requests
- New examples and example improvements (#55)
...
### Merged Pull Requests
- Nonlinear finite-volume + AvgMPFA support (#52)
...
- Hysteresis & relperm refactoring (#51)
...
### Merged Pull Requests
- Improved performance, better behavior on input cases (#47)
...
### Merged Pull Requests
- Improved initialization, thermal output and grid processing (#46)
...
### Merged Pull Requests
- Improved adjoint support, additional grid processing keywords (#42)
...
### Merged Pull Requests
- Attempt at making GLMakie work in examples (#34)
- Pre-solver for wells, improved MS well parsing, better NLDD support (#35)
- Updates to docs + add CO2-brine model from CSP11 (#36)
...
### Merged Pull Requests
- Add nonlinear domain decomposition solvers (#33)
...
### Merged Pull Requests
- Remove parser that is moved to GeoEnergyIO (#31)
...
### Merged Pull Requests
- Upgrades to .DATA and corner point grid parsers (#28)
...
### Merged Pull Requests
- CompatHelper: add new compat entry for Statistics at version 1, (keep existing compat) (#23) (@github-actions[bot])
- remove dependency of internal fields of `eos::AbstractEOS` (#24)
- small clean-up of case setup from mrst data (#25)
- CPR rewrite + performance improvements (#26)

### Closed Issues
- CO2 brine example not working (#22)

### Contributors
[@moyner](https://github.com/moyner), [@brunompacheco](https://github.com/brunompacheco), [@longemen3000](https://github.com/longemen3000)
...
### Merged Pull Requests
- Support for parsing and simulating .DATA files (#19)
...
### Merged Pull Requests
- Port over JutulExamples cases (#16)
- Add new ex to docs (#17)
...
- MPI solve with HYPRE + PartitionedArrays (#15)

### Contributors
[@moyner](https://github.com/moyner), [@timholy](https://github.com/timholy)

## [v0.2.3] - 2023-04-22

### Merged Pull Requests
- Documentation updates and other small fixes (#11)
- remove output path during precompilation (#13)

### Closed Issues
- No writing access to `/tmp` leads to error during precompilation (#12)

### Contributors
[@moyner](https://github.com/moyner), [@ziyiyin97](https://github.com/ziyiyin97)

## [v0.2.2] - 2023-03-19

### Merged Pull Requests
- Add parameters kwarg to setup_reservoir_model (#10) (@gbruer15)

### Contributors
[@grantbruer](https://github.com/grantbruer)
...
### Merged Pull Requests
- Support for VAPOIL (#6)
- Improve input case support, VAPOIL/DISGAS systems, other fixes (#8)
...
- Csr (#1)
- Generalized AD (#2)
- Refactor parameter logic + other fixes (#3)
- Rewrite flux to support sensitivities (#4)
