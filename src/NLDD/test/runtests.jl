using Test, NLDD, Jutul, JutulDarcy
##
NLDD.test_aspen_physics();
##
function test_on_mrst_case(name, b = true; steps = :full)
    ...
    results_newton = bench_dd(name, :fi; sim_arg...);
    ...
    @testset "NLDD on $name" begin
        ...
        @testset "ASPEN" begin
            results_as = bench_dd(name, :aspen;
            sim_arg...);
