...
# """
# function update_half_face_flux!(law::ConservationLaw, storage, model, dt, flowd::TwoPointPotentialFlowHardCoded{U, K, T}) where {U,K,T<:TotalMassVelocityMassFractionsFlow}
#     state = storage.state
