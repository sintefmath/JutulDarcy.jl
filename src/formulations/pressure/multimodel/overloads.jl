...
function Jutul.update_cross_term_in_entity!(out, i,
    ...
    state_s, state0_s, 
    model_t, model_s,
    ct::PressureReservoirFromWellFlowCT, arg...)
...
function Jutul.cross_term_entities(ct::PressureReservoirFromWellFlowCT, eq, model)
    Jutul.cross_term_entities(ct.parent, eq, model)
end

function Jutul.cross_term_entities_source(ct::PressureReservoirFromWellFlowCT, eq, model)
    Jutul.cross_term_entities_source(ct.parent, eq, model)
end
