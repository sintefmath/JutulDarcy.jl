...
# SPE9: Black-oil depletion with dissolved gas {#SPE9:-Black-oil-depletion-with-dissolved-gas}

[Killough, J. E. 1995. Ninth SPE comparative solution project: A reexamination of black-oil simulation. In SPE Reservoir Simulation Symposium,  12-15 February 1995, San Antonio, Texas. SPE 29110-MS](http://dx.doi.org/10.2118/29110-MS) [[14](/extras/refs#spe9)]
...
## Producer water rate {#Producer-water-rate}
...
## Oil produciton rate {#Oil-produciton-rate}
...
If you would like to run this example yourself, it can be downloaded from the JutulDarcy.jl GitHub repository [as a script](https://github.com/sintefmath/JutulDarcy.jl/blob/main/examples/validation/validation_spe9.jl), or as a [Jupyter Notebook](https://github.com/sintefmath/JutulDarcy.jl/blob/gh-pages/dev/final_site/notebooks/validation/validation_spe9.ipynb)

```
This example took 20.315399334 seconds to complete.
```
