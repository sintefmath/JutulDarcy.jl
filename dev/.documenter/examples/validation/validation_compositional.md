...
# Validation of equation-of-state compositional flow {#Validation-of-equation-of-state-compositional-flow}
...
```
Jutul: Simulating 19 years, 32.21 weeks as 500 report steps
╭────────────────┬───────────┬───────────────┬──────────╮
│ Iteration type │  Avg/step │  Avg/ministep │    Total │
│                │ 500 steps │ 503 ministeps │ (wasted) │
├────────────────┼───────────┼───────────────┼──────────┤
│ Newton         │      3.03 │       3.01193 │ 1515 (0) │
│ Linearization  │     4.036 │       4.01193 │ 2018 (0) │
│ Linear solver  │      3.03 │       3.01193 │ 1515 (0) │
│ Precond apply  │      6.06 │       6.02386 │ 3030 (0) │
╰────────────────┴───────────┴───────────────┴──────────╯
╭───────────────┬─────────┬────────────┬─────────╮
│ Timing type   │    Each │   Relative │   Total │
│               │      ms │ Percentage │       s │
├───────────────┼─────────┼────────────┼─────────┤
│ Properties    │ 19.5604 │    76.86 % │ 29.6339 │
│ Equations     │  0.6262 │     3.28 % │  1.2637 │
│ Assembly      │  0.3222 │     1.69 % │  0.6502 │
│ Linear solve  │  0.4729 │     1.86 % │  0.7164 │
│ Linear setup  │  1.0663 │     4.19 % │  1.6155 │
│ Precond apply │  0.1877 │     1.48 % │  0.5688 │
│ Update        │  0.5435 │     2.14 % │  0.8234 │
│ Convergence   │  0.6679 │     3.50 % │  1.3479 │
│ Input/Output  │  0.2016 │     0.26 % │  0.1014 │
│ Other         │  1.2111 │     4.76 % │  1.8349 │
├───────────────┼─────────┼────────────┼─────────┤
│ Total         │ 25.4496 │   100.00 % │ 38.5562 │
╰───────────────┴─────────┴────────────┴─────────╯
```


## Plot solutions and compare {#Plot-solutions-and-compare}
...
## Calculate sensitivities {#Calculate-sensitivities}
...
If you would like to run this example yourself, it can be downloaded from the JutulDarcy.jl GitHub repository [as a script](https://github.com/sintefmath/JutulDarcy.jl/blob/main/examples/validation/validation_compositional.jl), or as a [Jupyter Notebook](https://github.com/sintefmath/JutulDarcy.jl/blob/gh-pages/dev/final_site/notebooks/validation/validation_compositional.ipynb)

```
This example took 189.958897996 seconds to complete.
```
