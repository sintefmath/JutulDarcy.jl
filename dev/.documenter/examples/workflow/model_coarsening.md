...
# Model coarsening {#Model-coarsening}
...
## Coarsen the model and plot partition {#Coarsen-the-model-and-plot-partition}
...
### Compare fine-scale and coarse-scale permeability {#Compare-fine-scale-and-coarse-scale-permeability}
...
### Simulate the coarse-scale model {#Simulate-the-coarse-scale-model}
...
```
  1.112309 seconds (3.75 M allocations: 313.914 MiB, 3.41% gc time, 3.40% compilation time: 100% of which was recompilation)
```


### Plot and compare the coarse-scale and fine-scale solutions {#Plot-and-compare-the-coarse-scale-and-fine-scale-solutions}
...
### Plot and compare the saturation fields {#Plot-and-compare-the-saturation-fields}
...
### Plot the average field scale pressure evolution {#Plot-the-average-field-scale-pressure-evolution}
...
### Plot the wells interactively {#Plot-the-wells-interactively}
...
### Plot field scale measurables over time interactively {#Plot-field-scale-measurables-over-time-interactively}
...
## Compare different partitioning methods {#Compare-different-partitioning-methods}
...
If you would like to run this example yourself, it can be downloaded from the JutulDarcy.jl GitHub repository [as a script](https://github.com/sintefmath/JutulDarcy.jl/blob/main/examples/workflow/model_coarsening.jl), or as a [Jupyter Notebook](https://github.com/sintefmath/JutulDarcy.jl/blob/gh-pages/dev/final_site/notebooks/workflow/model_coarsening.ipynb)

```
This example took 54.501750748 seconds to complete.
```
