...
# Borehole Thermal Energy Storage (BTES) {#Borehole-Thermal-Energy-Storage-BTES}
...
## Define BTES well coordinates {#Define-BTES-well-coordinates}
...
## Set up mesh function {#Set-up-mesh-function}
...
## Create BTES mesh {#Create-BTES-mesh}
...
### Set up BTES wells {#Set-up-BTES-wells}
...
## Initial state and boundary conditions {#Initial-state-and-boundary-conditions}
...
### Assemble schedule {#Assemble-schedule}
...
## Set simulator and run {#Set-simulator-and-run}
...
│               │       ms │ Percentage │       s │
├───────────────┼──────────┼────────────┼─────────┤
│ Properties    │   2.6373 │     2.24 % │  1.6351 │
│ Equations     │  34.7751 │    44.57 % │ 32.5147 │
│ Assembly      │  11.1737 │    14.32 % │ 10.4474 │
│ Linear solve  │   2.2436 │     1.91 % │  1.3910 │
│ Linear setup  │  18.2611 │    15.52 % │ 11.3219 │
│ Precond apply │   1.1504 │     4.35 % │  3.1728 │
│ Update        │   3.0383 │     2.58 % │  1.8837 │
│ Convergence   │   7.5480 │     9.67 % │  7.0573 │
│ Input/Output  │   0.7121 │     0.31 % │  0.2243 │
│ Other         │   5.3162 │     4.52 % │  3.2961 │
├───────────────┼──────────┼────────────┼─────────┤
│ Total         │ 117.6521 │   100.00 % │ 72.9443 │
╰───────────────┴──────────┴────────────┴─────────╯
```


## Inspect reservoir states {#Inspect-reservoir-states}
...
## Inspect well solutions {#Inspect-well-solutions}
...
If you would like to run this example yourself, it can be downloaded from the JutulDarcy.jl GitHub repository [as a script](https://github.com/sintefmath/JutulDarcy.jl/blob/main/examples/geothermal/btes.jl), or as a [Jupyter Notebook](https://github.com/sintefmath/JutulDarcy.jl/blob/gh-pages/dev/final_site/notebooks/geothermal/btes.ipynb)

```
This example took 127.747299079 seconds to complete.
```
