...
# Consistent and high-resolution: WENO, NTPFA and AvgMPFA {#Consistent-and-high-resolution:-WENO,-NTPFA-and-AvgMPFA}

The following example demonstrates how to set up a reservoir model with different discretizations for flow and transport for a skewed grid. The model setup is taken from 6.1.2 in the MRST book [[1](/extras/refs#mrst-book-i)].
...
## Define wells, fluid system and controls {#Define-wells,-fluid-system-and-controls}
...
## Define functions to perform the simulations {#Define-functions-to-perform-the-simulations}
...
### Function to perform simulation {#Function-to-perform-simulation}
...
### Function to plot the results {#Function-to-plot-the-results}
...
### Function to simulate and plot discretizations {#Function-to-simulate-and-plot-discretizations}
...
### Simulate SPU-TPFA {#Simulate-SPU-TPFA}
...
### Simulate SPU-AvgMPFA {#Simulate-SPU-AvgMPFA}
...
### Simulate SPU-TPFA {#Simulate-SPU-TPFA-2}
...
### Simulate WENO-TPFA {#Simulate-WENO-TPFA}
...
### Simulate WENO-AvgMPFA {#Simulate-WENO-AvgMPFA}
...
## Compare the saturation fields as contours {#Compare-the-saturation-fields-as-contours}
...
### Compare SPU-TPFA and SPU-AvgMPFA {#Compare-SPU-TPFA-and-SPU-AvgMPFA}
...
### Compare WENO-TPFA and SPU-TPFA {#Compare-WENO-TPFA-and-SPU-TPFA}
...
### Compare WENO-AvgMPFA and SPU-TPFA {#Compare-WENO-AvgMPFA-and-SPU-TPFA}
...
If you would like to run this example yourself, it can be downloaded from the JutulDarcy.jl GitHub repository [as a script](https://github.com/sintefmath/JutulDarcy.jl/blob/main/examples/discretization/mpfa_weno_discretizations.jl), or as a [Jupyter Notebook](https://github.com/sintefmath/JutulDarcy.jl/blob/gh-pages/dev/final_site/notebooks/discretization/mpfa_weno_discretizations.ipynb)

```
This example took 61.677840159 seconds to complete.
```
